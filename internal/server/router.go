...
func NewRouter(h *Handler) http.Handler {
	...
	mux.HandleFunc("/userd3/mypostUpdate", h.UpdatePost) // Изменение и удаление поста (метод PUT)
	mux.HandleFunc("/userd3/mypostDelete", h.DeletePost) // Изменение и удаление поста (метод DELETE)
